...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            verification_link = f"http://{current_site.domain}{reverse('accounts:activate', kwargs={'uidb64': uid, 'token': token})}"

            # Email subject
            subject = "Activate Your ShopNG Account"
            ...
            <head>
                ...
                <style>
                    ...
                    .container {{ background: #ffffff; max-width: 600px; margin: auto; padding: 30px; border-radius: 10px;
                                  box-shadow: 0px 2px 8px rgba(0,0,0,0.1); }}
                    h2 {{ color: #333; }}
                    .btn {{ display: inline-block; margin-top: 20px; padding: 12px 20px; background-color: #4CAF50; 
            ...
            <body>
                <div class="container">
                    ...
                    <div class="footer">
                        <p>© {timezone.now().year} ShopNG. All rights reserved.</p>
                    </div>
                </div>
            </body>
            </html>
